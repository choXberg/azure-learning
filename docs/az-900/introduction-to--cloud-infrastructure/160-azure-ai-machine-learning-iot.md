...
Diagram showing devices sending telemetry through IoT Hub to cloud analytics and IoT Edge runtime for local processing.

Choosing the right option
At a fundamentals level, use this decision pattern:

Decision triad: AI services, Azure ML, and IoT services.
